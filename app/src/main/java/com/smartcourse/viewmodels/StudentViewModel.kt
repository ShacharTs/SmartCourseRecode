...
class StudentViewModel @Inject constructor(
    ...
    fun loadRecentChats() {
        viewModelScope.launch {
            _recentChats.value = userRepository.loadRecentChats(userObj.getUID())
        }
    }
    ...
    fun openChatWith(otherUserId: String, navController: NavController) {
        ...
        val vm = ChatViewModel(chatRepo, userRepository)
        vm.openChatWith(otherUserId, userObj.getUID(), navController)
    }
