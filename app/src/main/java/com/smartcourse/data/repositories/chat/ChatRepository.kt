...
//        senderName: String
//    ) {
//        Log.d("FCM_DEBUG", "sendMessage called. To: $otherId")
...
//                if (error != null) {
//                    Log.e("FIRESTORE_ERROR", "Messages listen failed: ${error.message}")
...
//                    Log.e("FIRESTORE_ERROR", "Chats list failed: ${error.message}")
//                    onChats(emptyList())
//                    return@addSnapshotListener
//                }
//
